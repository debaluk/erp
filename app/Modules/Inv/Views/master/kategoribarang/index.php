...
<script>
    $(document).ready(function() {
        const table = $("#table-kategori").DataTable({
            ...
            order: [],
            ajax: {
                url: `${BASE_URL}/master/kategoribarang/ajax`
            },
            //optional
            lengthMenu: [
                [10, 25,50,100],
        ...
        $(".content").on("click", "#tambah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: `${BASE_URL}/master/kategoribarang/tambah`,
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
        ...
        $(".content").on("click", "#ubah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: `${BASE_URL}/master/kategoribarang/ubah`,
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
        ...
        $(".content").on("click", ".hapus", function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `${BASE_URL}/master/kategoribarang/hapus`,
                        data: {
                            id: $(this).data("id")
                        },
                        success: function(response) {
