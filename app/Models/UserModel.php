...
class UserModel extends Model
{
    ...
    public function getRoleakses($idsuer)
    {
        return $this->builder('tb_role_akses')->select('*')->orderBy('id_role', 'asc')
        ->join('tb_roles','tb_roles.id=tb_role_akses.id_role')
        ->where('tb_role_akses.id_user', $idsuer)
        ->get()
        ->getResult();
    }
}
