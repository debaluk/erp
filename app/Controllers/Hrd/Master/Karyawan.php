...
class Karyawan extends BaseController {
    ...
    public function index() {
        $data = [
            'title'    => 'Jenis Barang',
            'kategori' => $this->karyawan->getKategori(),            
        ];
        echo view('hrd/master/jenisbarang/index', $data);
    ...
    public function ajax() {
        if ($this->request->isAJAX()) {
            ...
            ->select('inv_jenis_barang.jenis_barang_id,inv_jenis_barang.kategori_barang_id as kategoriid,inv_jenis_barang.kode as kode, inv_jenis_barang.jenis_barang as jenisbarang, inv_jenis_barang.keterangan as keterangan, inv_kategori_barang.kategori_barang as karyawan')
