    ...
    public function tambah()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$this->validate($this->rules)) {
                ...
                $data = [
                    'username' => strtolower($this->request->getPost('username', FILTER_UNSAFE_RAW)),
                    'email' => $email,
    ...
    public function ubah()
    {
        ...
        if ($this->request->isAJAX()) {
            if (!$this->validate($this->rules)) {
                ...
                $photo = $this->request->getPost('avatarLama', FILTER_UNSAFE_RAW);
                // photo diisi
