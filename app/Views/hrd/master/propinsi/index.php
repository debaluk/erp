...
<div class="container-fluid">
    <button class="btn btn-primary mb-1 tambah"><i class="fas fa-plus"></i> Tambah Propinsi</button>
...
<script>
    $(document).ready(function() {
        const table = $("#table-kategori").DataTable({
            ...
            order: [],
            ajax: {
                url: `${BASE_URL}/hrd/master/propinsi/ajax`
            },
            //optional
            lengthMenu: [
                [10, 25,50,100],
        ...
        $(".content").on("click", "#tambah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: `${BASE_URL}/hrd/master/propinsi/tambah`,
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
                ...
                success: function(response) {
                    responValidasi(['tambah'], ['nama'], response);
                    if (response.sukses) {
        ...
        $(".content").on("click", "#ubah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: `${BASE_URL}/hrd/master/propinsi/ubah`,
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
        ...
        $(".content").on("click", ".hapus", function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `${BASE_URL}/hrd/master/propinsi/hapus`,
                        data: {
                            id: $(this).data("id")
                        },
                        success: function(response) {
